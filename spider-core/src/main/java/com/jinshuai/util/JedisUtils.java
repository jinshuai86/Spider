...
public class JedisUtils {
     ...
     * 获取套接字、密码
     * */
    private static final String IP = PropertiesUtils.getInstance().get("redis-ip");
    private static final int PORT = Integer.valueOf(PropertiesUtils.getInstance().get("redis-port"));
    private static final String PASSWORD = PropertiesUtils.getInstance().get("redis-password");
